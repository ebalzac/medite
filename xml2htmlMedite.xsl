...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="table" mode="text1">
    ...
    <xsl:template match="table" mode="text2">
        <xsl:element name="table">
            <xsl:attribute name="class">table</xsl:attribute>
            <xsl:element name="tbody">
    ...
    <xsl:template match="row" mode="text1">
        <xsl:element name="tr">
            <xsl:apply-templates mode="text1"/>
        </xsl:element>
    </xsl:template>
    
    <xsl:template match="row" mode="text2">
        <xsl:element name="tr">
            <xsl:apply-templates mode="text2"/>
        </xsl:element>
    </xsl:template>
    
    <xsl:template match="cell" mode="text1">
        <xsl:element name="td">
            <xsl:apply-templates mode="text1"/>
        </xsl:element>
    </xsl:template>
    
    <xsl:template match="cell" mode="text2">
        <xsl:element name="td">
            <xsl:apply-templates mode="text2"/>
        </xsl:element>
    </xsl:template>
